<script setup>
import { ref } from 'vue';
import TimeDetailsPopup from '@/components/TimeDetailsPopup.vue';
...
<template>
  <div class="subscription-page">
    ...
    <section class="adjust-account">
      <h2>How many hours do you want to purchase?</h2>
      ...
      <div class="confirm-order">
        <h3>Total price:</h3>
        <p>100 ADCO</p>
        <button @click="showTimeDetails" class="continue-button">Confirm order</button>
      </div>
    </section>

    <TimeDetailsPopup v-if="showPopup" @close="closePopup" />
  </div>
</template>
...
.account-category p, .confirm-order p {
  font-size: 1.5rem;
  color: #ffffff;
}
